...
public class SquareTriangle extends Square {
	...
	public String[] presentation(int offset) {
		...
		res[0] = isLeftDiagonal ? super.getOffset(offset)+getSymbol() : super.getOffset(offset+ super.getWidth()-1) + getSymbol();
	...
	protected String getMidlleLine(int offset, int i) {
		...
		String left = getOffset(offset) + symbol + getOffset(i-1) + symbol;
		String right = getOffset(offset + super.getWidth() - i-1) + symbol + getOffset(i-1) + symbol ;
