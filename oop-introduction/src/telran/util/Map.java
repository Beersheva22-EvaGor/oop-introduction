...
public interface Map<K, V> {
	 ...
	 * @return reference to old value if the value is replace with new value
	 */
	V put(K key, V value);
	 ...
	 * @param key
	 * @param value
	 * adds new entry if entry doesn't exist (no updating)
	 * @return null if new entry is added
	 * @return reference to value if the value is replaced with new value
	 */
	 ...
	 * 
	 * @param key
	 * @return value matching the given key or null if no entry with the key
	 */
	V get(K key);
	 ...
	 * @param key
	 * @param value
	 * @return  value matching the given key or the given value(second parameter) if no entry with the key
	 */
